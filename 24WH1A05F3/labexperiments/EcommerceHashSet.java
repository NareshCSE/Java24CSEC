...
public class EcommerceHashSet{
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Seller seller = new Seller();

       
        seller.addProduct(new Product(101, "Laptop", 5000));
        seller.addProduct(new Product(102, "Smartphone", 2500));
        seller.addProduct(new Product(103, "Headphones", 100));
        seller.addProduct(new Product(104, "watch", 500));
