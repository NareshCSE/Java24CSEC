...
class SBI implements Bank5 {
 ...
 public void createAccount(String name, int accNo) {
     ...
     this.accNo = accNo;
     this.balance = 0;
     System.out.println("SBI Account created for " + name + " with account number " + accNo);
 }
...
class Axis implements Bank5 {
 ...
 public void createAccount(String name, int accNo) {
     ...
     this.accNo = accNo;
     this.balance = 0;
     System.out.println("Axis Account created for " + name + " with account number " + accNo);
 }
...
//Main class demonstrating late binding and using the interface reference
